...
/**
 * This is the item provider adapter for a {@link org.example.dm.StringType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    protected void addLengthPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StringType_length_feature",
                                "_UI_StringType_type"),
                        DmPackage.Literals.STRING_TYPE__LENGTH,
                        true,
                        false,
                        false,
    ...
    protected void addMinLengthPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StringType_minLength_feature",
                                "_UI_StringType_type"),
                        DmPackage.Literals.STRING_TYPE__MIN_LENGTH,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addMaxLengthPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StringType_maxLength_feature",
                                "_UI_StringType_type"),
                        DmPackage.Literals.STRING_TYPE__MAX_LENGTH,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addPatternPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_StringType_pattern_feature",
                                "_UI_StringType_type"),
                        DmPackage.Literals.STRING_TYPE__PATTERN,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
