...
/**
 * This is the item provider adapter for a {@link org.example.dm.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider extends NamedElementItemProvider {
    ...
    protected void addDataModelPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Relationship_dataModel_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Relationship_dataModel_feature",
                                "_UI_Relationship_type"),
                        DmPackage.Literals.RELATIONSHIP__DATA_MODEL,
                        true,
                        false,
                        true,
                        null,
    ...
    protected void addKindPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_Relationship_kind_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Relationship_kind_feature",
                                "_UI_Relationship_type"),
                        DmPackage.Literals.RELATIONSHIP__KIND,
                        true,
                        false,
                        false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DmPackage.Literals.RELATIONSHIP__ENDS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(DmPackage.Literals.RELATIONSHIP__ENDS,
                DmFactory.eINSTANCE.createRelationshipEnd()));
    }
